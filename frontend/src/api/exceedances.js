...
export const getAnnotationBatch = (requestId) => http.get(`/exceedances/annotations/${requestId}`)
export const fetchExceedanceIds = (params) =>
  http.get('/exceedances/ids', { params: toParams(params) })
